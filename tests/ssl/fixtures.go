...
var (
	TestCreateSSLExpected = &gcore.CertSSL{
		...
		ValidityNotAfter:    gcore.NewTime(time.Date(2018, time.July, 12, 16, 1, 59, 0, time.UTC)),
		ValidityNotBefore:   gcore.NewTime(time.Date(2018, time.April, 13, 16, 1, 59, 0, time.UTC)),
	}
